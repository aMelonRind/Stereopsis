            ...
            return YetAnotherConfigLib.createBuilder()
                    ...
                    .category(ConfigCategory.createBuilder()
                            ...
                            .option(Option.<Boolean>createBuilder()
                                    ...
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(translatable("lockCrosshairY"))
                                    .description(descriptionOf("lockCrosshairY"))
                                    .binding(def.lockCrosshairY, () -> cfg.lockCrosshairY, val -> cfg.lockCrosshairY = val)
                                    .controller(TickBoxControllerBuilder::create)
                                    .build())
                            ...
                            .option(Option.<Float>createBuilder()
                                    ...
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(translatable("splitHud"))
                                    .description(descriptionOf("splitHud"))
                                    .binding(def.splitHud, () -> cfg.splitHud, val -> cfg.splitHud = val)
                                    .controller(TickBoxControllerBuilder::create)
                                    .build())
                            .option(Option.<Boolean>createBuilder()
                                    .name(translatable("inverseHudXOffsetDirection"))
                                    .description(descriptionOf("inverseHudXOffsetDirection"))
                                    .binding(def.inverseHudXOffsetDirection, () -> cfg.inverseHudXOffsetDirection, val -> cfg.inverseHudXOffsetDirection = val)
                                    .controller(TickBoxControllerBuilder::create)
                                    .build())
